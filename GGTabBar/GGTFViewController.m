...
@interface GGTFViewController ()

@end

@implementation GGTFViewController

-(instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        UITabBarItem *itm = [[UITabBarItem alloc]initWithTitle:@"帕尼" image:[UIImage imageNamed:@"tabbar_discover"] selectedImage:[UIImage imageNamed:@"tabbar_discover"]];
        self.tabBarItem = itm;
    }
    return self;
}
...
- (void)viewDidLoad {
    ...
    UIImageView *newImage = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Tiffany"]];
    ...
    [newBtn setTitle:@"蒂芬妮" forState:UIControlStateNormal];
