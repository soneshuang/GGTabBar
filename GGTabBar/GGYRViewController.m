...
@interface GGYRViewController ()

@end

@implementation GGYRViewController

-(instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        UITabBarItem *itm = [[UITabBarItem alloc]initWithTitle:@"黑珍珠" image:[UIImage imageNamed:@"tabbar_discover"] selectedImage:[UIImage imageNamed:@"tabbar_discover"]];
        self.tabBarItem = itm;
    }
    return self;
}
...
- (void)viewDidLoad {
    ...
    UIImageView *newImage = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Yuri"]];
    ...
    [newBtn setTitle:@"权侑丽" forState:UIControlStateNormal];
